...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/train/exp10/weights/best.pt', help='trained weights path')
    # parser.add_argument('--weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-prune4/weights/model_c2f_v2.pt', help='trained weights path')
    parser.add_argument('--weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-finetune13/weights/best.pt', help='trained weights path')
