...
model = YOLO('C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-finetune4/weights/best.pt')  # 模型文件路径，准确度n<s<m<l
...
def process_image(image_path):
    ...
    if image is not None:
        ...
        # 在图像上添加文本信息
        cv2.putText(annotated_image, f"Ungerminated: {num_0}", (50, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        # cv2.putText(annotated_image, f"Germinated: {num_1}", (50, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
...
if __name__ == "__main__":
    input_source = 'C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/se_t/10C/3/'
    # input_source = 'ultralytics/assets/street_30s.mp4'
    # input_source = 'rtsp://admin:admin@192.168.50.74:8554/live'
    # input_source = 'street.mp4'     #设置输入文件路径
    main(input_source)
