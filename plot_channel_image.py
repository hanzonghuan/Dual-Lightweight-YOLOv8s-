...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-prune4/weights/model_c2f_v2.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-prune4/weights/prune.pt', help='prune weights path')
    # parser.add_argument('--prune-weights', type=str, default='C:/Users/CAU/Desktop/Fifth/ultralytics-20240323_ceshi/ultralytics-main/runs/prune/yolov8-BIFPN-EfficientRepHead2-finetune4/weights/best.pt', help='prune weights path')
